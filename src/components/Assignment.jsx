          ...
          <div className="pr-8">
            ...
            <div className="mb-4">
              ...
              <p className="text-gray-700">
                ...
                Phasellus vel enim euismod, lobortis sapien sed, dapibus dolor.
                Nam porttitor, libero nec bibendum lobortis, sapien ex iaculis
                nulla, eget tempor justo lectus a velit.
              </p>
            </div>
          </div>
          {isTA ? (
